...
parser.add_argument("--data_root", 
                default="/media/capsule2232/New Volume/ulcer_data_real",
                help="Video data root with three subfolders (fold 1,2 and 3)")

parser.add_argument("--out_dir", 
                default="/home/capsule2232/classification/Output_Densenet",
...
parser.add_argument("--action", type=str, help="Select an action to run", default="train", choices=["train", "retrain", "test", "check", "prepare"])
