...
parser.add_argument("--data_root", 
                default="/home/capsule2232/classification/data_gi_tract",
...
# Action handling 
parser.add_argument("--num_epochs", type=int, default=5, help="Numbe of epochs to train")
# parser.add_argument("--start_epoch", type=int, default=0, help="Start epoch in retraining")
parser.add_argument("--action", type=str, help="Select an action to run", choices=["train", "retrain", "test", "check", "prepare"], default="train")
parser.add_argument("--checkpoint_interval", type=int, default=5, help="Interval to save checkpoint models")
parser.add_argument("--val_fold", type=str, default="validation", help="Select the validation fold")
parser.add_argument("--all_folds", default="training", help="list of all folds available in data folder")
...
checkpoint_dir = "/home/capsule2232/classification/checkpoints/"
...
for i,j,k in data_val:
    print(i)    
input_tensor = i # Create an input tensor image for your model..
